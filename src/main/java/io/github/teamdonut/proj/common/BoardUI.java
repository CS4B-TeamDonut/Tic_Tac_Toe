    ...
    public BoardUI() {
        try {
            xImage = new Image(Objects.requireNonNull(
                    getClass().
                    getClassLoader().
                    getResourceAsStream("io/github/teamdonut/proj/images/common/X_white.png")
            ));
            oImage = new Image(Objects.requireNonNull(
                    getClass().
                    getClassLoader().
                    getResourceAsStream("io/github/teamdonut/proj/images/common/O_white.png")
            ));
            emptyImage = new Image(Objects.requireNonNull(
                    getClass().
                    getClassLoader().
                    getResourceAsStream("io/github/teamdonut/proj/images/common/Empty.png")
            ));
        } catch(Exception e) {
            Logger.log(e);
        }
